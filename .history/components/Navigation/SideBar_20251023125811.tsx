...
const SideBar = ({activeSidebar, setActiveSidebar}: {activeSidebar: boolean, setActiveSidebar: React.Dispatch<SetStateAction<boolean>>}) => {
  //Translations
        ...
        <div className={styles.side__wrap}>
          <div className={styles.sticky}>
            <div className={styles.sn__top}>
              ...
              <div className={styles.close__button} onClick={() => setActiveSidebar(true)}>
                <span>Close</span>
              </div>
            </div>

...
const Footer = ({
  ...
  return (
    <div className={styles.footer__wrapone}>
      <div className={styles.footer__wraptwo}>
            ...
            <div className={`container ${styles.fs__container}`}>
              <div className={styles.fsc__left}>
                <div className={styles.fsl__top}>
                  <span className={styles.fs__span}>
                    {t("Navigation:coordones")}
                  </span>
          ...
          <div className={styles.fs__bottom}>
            ...
            <div className={styles.fs__last}>
              <div className={`container ${styles.fs__laster}`}>
                <span className={styles.first__copy}>{t("Navigation:copyright")}</span>
                <span className={styles.second__copy}>{t("Navigation:copyright")}</span>
                <span className={styles.version}>Version 2025</span>
                <span>
                  {t("Navigation:websiteby")}{" "}
                  <span className={styles.bafri} onClick={() => setActiveNeider(true)}>
                    BAFRI Schneider
                  </span>
                </span>
              </div>

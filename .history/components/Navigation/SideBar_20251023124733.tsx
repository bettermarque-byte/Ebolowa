    ...
    <div className={styles.sidebar}>
      ...
      <div className={styles.sidenav}>
        <div className={styles.side__wrap}>
          ...
          <div className={styles.snbottom__w}>

          </div>
          <div className={styles.sn__bottom}>
            {modalOne.map((data, i) => (
              <div className={`${styles.sn__nav} ${activeAccordion===i ? styles.active__acc : ""}`} key={i}>
                <div className={styles.snn__top} onClick={() => activeAccordion===i ? setActiveAccordion(-1) : setActiveAccordion(i)}>

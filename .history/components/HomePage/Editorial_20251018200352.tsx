        ...
        <div className={styles.edito__wrapper}>
          ...
          <div className={styles.edito__right}>
            <div className={styles.er__one}>
              <p className={styles.ero__p}>Bienvenue au site de la ville d’Ebolowa</p>
            ...
            <div className={styles.er__two}>
              ...
              <RoundedButton text="Lire la suite" textTransform= "initial" fontSize="var(--normal-fontt-size)" fontFamily="var(--medium-font)" border="1px solid var()" borderHover="1px solid var(--green)"/>
            </div>

...
import IMAGE from "../../public/images/imageseven.jpg";
import IMAGE2 from "../../public/images/imagesix.jpg";
import IMAGE3 from "../../public/images/imagefour.jpg";
import IMAGE4 from "../../public/images/imageeight.jpg";
import IMAGE5 from "../../public/images/imagethree.jpg";
...
const Photos = () => {
  ...
  const photoImages = [
    {
      name: t("HomePage:image1"),
      image: IMAGE,
    },
    {
      name: t("HomePage:image2"),
      image: IMAGE2,
    },
    {
      name: t("HomePage:image3"),
      image: IMAGE3,
    },
    {
      name: t("HomePage:image4"),
      image: IMAGE4,
    },
    {
      name: t("HomePage:image5"),
      image: IMAGE5,
    },
  ];
  return (
            ...
            <div className={styles.pc__left}>
              {photoImages.map((data, i) => (
                <div
                  ...
                  key={i}
                >
                  <Image placeholder="blur" quality={100} fill alt={data.name} src={data.image} />
                </div>
              ))}

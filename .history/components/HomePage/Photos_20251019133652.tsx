          ...
          <div className={styles.pc__top}>
            <div className={styles.pc__left}>
              {photoImages.map((data, i) => (
                <div className={`${styles.pc__image} ${activeSlide===i ? styles.active__pc : ""}`} key={i}>
                  <Image quality={100} fill alt={data.name} src={data.image} />
                </div>
              ))}
              <div className={styles.pct__content}>
                <h3 className={styles.pc__h3}>{photoImages[activeSlide].name}</h3>
            ...
            <div className={styles.pc__right}>
              {photoImages.map((data, i) => (
                <div className={`${styles.pc__image2} ${activeSlide===i ? styles.active__pc2 : ""}`} key={i} onClick={() => setActiveSlide(i)}>
                  <Image quality={100} fill alt={data.name} src={data.image} />
                </div>
              ))}
            </div>

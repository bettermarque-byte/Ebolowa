...
const HeroSection = () => {
  ...
  return (
    <div className={styles.hero__section}>
      ...
      <div className={styles.hero__sectioner}>

      </div>
      <div className={`container ${styles.hero__main}`}>
        <div className={styles.hero__content}>
          <h1 className={styles.hero__h3}>Bienvenue à la Communauté Urbaine d’Ebolowa</h1>
          <p className={styles.hero__p}>Ebolowa, une ville dynamique, solidaire et tournée vers l’avenir, au cœur du développement agro-pastoral du Cameroun.</p>
        </div>
      </div>
    </div>
  )

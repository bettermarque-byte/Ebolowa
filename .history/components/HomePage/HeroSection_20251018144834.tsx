    ...
    <div className={styles.hero__section}>
      ...
      <div className={`container ${styles.hero__main}`}>
        <div className={styles.hero__content}>
          <h3 className={styles.hero__h3}>Bienvenue à la Communauté Urbaine d’Ebolowa</h3>
          <p>Ebolowa, une ville dynamique, solidaire et tournée vers l’avenir, au cœur du développement agro-pastoral du Cameroun.</p>
        </div>
      </div>
    </div>
  )

        ...
        <div className={styles.edito__wrapper}>
          ...
          <div className={styles.edito__right}>
            ...
            <div className={styles.er__two}>
              ...
              <p>C’est avec un immense plaisir que nous  vous accueillons sur le tout premier site internet de la Ville  d’Ebolowa, un site qui, nous l’espérons, saura répondre à vos nombreuses et pressantes attentes. Reflet du dynamisme de notre Ville, ce  nouveau site est le fruit de plusieurs mois de collaboration active  entre la nouvelle équipe municipale, la Cellule de la Communication de  la Communauté Urbaine et les différents autres services communaux.  </p>
            </div>

...
import IMAGE2 from "../../public/images/news3.jpg";
import IMAGE3 from "../../public/images/news2.jpg";
import IMAGE4 from "../../public/images/news4.jpeg";
    ...
    <div className={`section ${styles.news__section}`}>
      <div className={`container ${styles.news__container}`}>
        ...
        <div className={styles.news__content}>
          {newsData.map((data, i) => (
            <NewsWrapper data={data} key={i} />
          ))}
        </div>
        <div className={styles.news__button}>
          <RoundedButton
            text={t("HomePage:news1Date")}

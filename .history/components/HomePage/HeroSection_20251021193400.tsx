...
const ComponentC = dynamic(() => import('./BackgroundSlideshow'), { ssr: false })
      ...
      <div className={styles.content__section}>
        <div className={`container ${styles.hero__main}`}>
          <div className={styles.hero__content}>
            ...
            {t("HomePage:proposhero")}
            </p>
            <div className={styles.hero__cta}>
              <RoundedButton text={t("HomePage:savoir")} textTransform= "initial" fontSize="var(--normal-font-size)" fontFamily="var(--medium-font)"/>
              <RoundedButtonTwo text={t("HomePage:contact")} textTransform= "initial" fontSize="var(--normal-font-size)" fontFamily="var(--medium-font)"/>
            </div>
          </div>
        </div>
      </div>

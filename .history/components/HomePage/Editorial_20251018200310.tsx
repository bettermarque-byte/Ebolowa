        ...
        <div className={styles.edito__wrapper}>
          ...
          <div className={styles.edito__right}>
            ...
            <div className={styles.er__two}>
              ...
              <RoundedButton text="Lire la suite" textTransform= "initial" fontSize="var(--normal-fontt-size)" fontFamily="var(--medium-font)" border="none" borderHover="1px solid var()"/>
            </div>

...
const RoundedButton = ({text, textTransform, fontSize, fontFamily, border}: {text: string, textTransform: React.CSSProperties["textTransform"], fontSize: string, fontFamily: string}) => {
  return (

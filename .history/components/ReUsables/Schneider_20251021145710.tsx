...
import { schneiderAnim, BackAm } from "@/animations";
        ...
        <div className={`container ${styles.modal__container}`}>
          ...
          <div className={styles.modal__left}>
            <div className={styles.ml__top}>
              ...
              <span className={styles.neider}>{t('Navigation:creative')}</span>
              <HighlightedText text={t('Navigation:aboutsch')} keywords={["bettermarque.com."]} color="var(--green)"/>
            </div>

          ...
          <div className={styles.modal__left}>
            ...
            <div className={styles.ml__bottom}>
              <div className={styles.cta}>
                ...
                <RoundedButton target="_blank" link="https://wa.me/23793370638" text="Whatsapp" textTransform= "initial" fontSize="var(--normal-font-size)" fontFamily="var(--medium-font)"/>
              </div>
              <div className={styles.cta}>
                <span>Portfolio</span>
                <RoundedButton target="_blank" link="https://bettermarque.com/projects" text="Portfolio" textTransform= "initial" fontSize="var(--normal-font-size)" fontFamily="var(--medium-font)"/>
              </div>
            </div>
          </div>
        </div>

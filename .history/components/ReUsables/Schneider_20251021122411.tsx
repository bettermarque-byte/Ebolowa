        ...
        <div className={`container ${styles.modal__container}`}>
          ...
          <div className={styles.modal__left}>
            <div className={styles.ml__top}>
              ...
              <p>
                With over 4 years in the design & development industry, Schneider runs the branding agency bettermarque.com. He holds a master's degree in Electrical Engineering with a specialisation in industrial robotics, which he obtained from the National Higher PolytecSchool
              </p>
            </div>

...
import styles from "../styles/Navigation/languageselectormobile.module.scss";
import { Angle } from "./icons/Angle";

export default function LanguageSelectorMobile({setLocalState}: 
{
  ...
  return (
    <div
      className={`${styles.ls__container} ${activeSelector ? styles.lsmain__active : ""}`}
      ref={containerRef}
      onClick={() => setActiveSelector((v) => !v)}
    >
      <div className={`${styles.ls__wrapper} ${activeSelector ? styles.ls__active : ""}`}>

...
const TeamContent = ({
  ...
  teamsData: { name: string; position: string; image: StaticImageData }[];
}) => {
  return (
    <div className={styles.team__content}>
      <Swiper className={styles.team__swiper} {...swiperSettings2} speed={800}>
          ...
          <SwiperSlide key={i} className={styles.team__slide}>
            <div className={styles.team__wrapper}>
              ...
              <div className={styles.team__data}>
                ...
                <span className={styles.team__position}>{data.position}</span>
              </div>
            </div>
          </SwiperSlide>
        ))}
